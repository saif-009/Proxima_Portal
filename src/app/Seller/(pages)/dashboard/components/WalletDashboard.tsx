...
const WalletDashboard = () => {
  ...
  return (
    <Card className="h-full w-full  " style={{
      ...
      <CardContent className="h-full p-2 flex flex-row justify-between items-center ">
        <div className='flex flex-col'>
          <CardTitle className="text-lg flex flex-row items-center font-medium capitalize ">
